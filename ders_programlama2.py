...
##her kaynak aldığımızda eğer kaynağı sormaya devam etmek istersek diye çalışıcak fonksiyon.Fonksiyon boolean tipinde döndürüyor
##ve biz while döngüsünde bu fonksiyon if şartı ile eğer fonksiyon değer olarak False diye döndürürse while döngüsünden çıkartmasını
